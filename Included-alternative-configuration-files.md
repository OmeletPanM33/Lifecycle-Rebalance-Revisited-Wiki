...
* **WG_CarHeavy.xml**: very heavy car usage for low-density residential areas.
* **WG_CitizenEdit.xml**: mod default settings; car usage for low-density residential areas is much higher than the game defaults, but car usage for high-density residential areas is a bit lower than the game default.
* **WG_GameDefaults.xml**: game default settings.